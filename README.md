...
This branch contains the raw data from an evaluation run on May 24, 2023 for

 * [Expat](expat/result-2023-05-24_14-09)
 * [libxcrypt](libxcrypt/result-2023-05-24_14-09)
 * [zlib](libxcrypt/result-2023-05-24_14-09)

generated by executing `./run-all.sh`.

### Evaluation system details

 * Intel Core i5-8400, 6 cores @ 2.80GHz
 * 16 GiB Ram
 * SSD
 * Debian Bullseye
   - *Ubuntu Jammy* packages extracted with additional tools
