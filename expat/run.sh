...
../tools/launchpad-dates.py -p release updates security proposed -s focal -- libexpat1
...
../tools/launchpad-dates.py -p release updates security proposed -s jammy -- libexpat1
